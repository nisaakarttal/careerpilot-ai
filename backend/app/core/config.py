...
class Settings(BaseSettings):
    ...
    GEMINI_EMBEDDING_MODEL: str = (
        ...
        if os.getenv("GEMINI_EMBEDDING_MODEL", "models/gemini-embedding-001") == "models/text-embedding-004"
        else os.getenv("GEMINI_EMBEDDING_MODEL", "models/gemini-embedding-001")
    )
