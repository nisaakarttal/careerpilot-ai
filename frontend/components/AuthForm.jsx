      ...
      <div className="w-full max-w-md relative z-10 my-auto">
        ...
        <div className="bg-white/75 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-2xl shadow-sky-900/10 border border-white/80 transition-all">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="flex items-start gap-3 text-sm text-rose-700 bg-rose-50/90 border border-rose-200/90 rounded-2xl p-3.5 shadow-sm backdrop-blur-md transition-all duration-300">
                <div className="p-1.5 rounded-lg bg-rose-100/90 text-rose-600 shrink-0 mt-0.5">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="font-semibold text-rose-900 text-xs tracking-wide uppercase">{isRegister ? "Kayıt Başarısız" : "Giriş Yapılamadı"}</p>
